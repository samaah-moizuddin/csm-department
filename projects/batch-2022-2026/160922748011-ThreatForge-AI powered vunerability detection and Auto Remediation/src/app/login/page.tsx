...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Use Auth0's Universal Login with pre-filled email
        ...
        >
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              Simulate intelligent attacks on your code before real hackers do.
            </p>
            ...
            <div className="space-y-4 pt-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">AI Red Team Analysis</h3>
                  <p className="text-sm text-muted-foreground">
                    Advanced threat simulation powered by Google Gemini
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Comprehensive vulnerability insights and recommendations
                  </p>
                </div>
              </div>
        ...
        >
          <div className="glass p-8 rounded-2xl border border-border/40 shadow-xl">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">Sign in to continue to CognitoForge</p>
            </div>
